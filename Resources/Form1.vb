Public Class Form1
    Public Sub New()
        'this call is required by the desinger'
        InitializeComponent()
        movetostar()
        'add any initialization after the initiakize comporent ()call. 
    End Sub
    ...
    Private Sub finish_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles finish.Click
        MessageBox.Show("well done obey ^__^!")
        Close()
